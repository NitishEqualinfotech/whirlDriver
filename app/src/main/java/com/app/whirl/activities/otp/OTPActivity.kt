...
import kotlinx.android.synthetic.main.activity_otpactivity.imageView
import kotlinx.android.synthetic.main.activity_otpactivity.rlLoader
...
class OTPActivity : AppCompatActivity() {
            ...
            override fun onResponse(
                ...
                if (response.body()!!.success) {
                    ...
                    if (intent.getStringExtra("type").equals("Login")) {
                        ...
                        if (response.body()!!.data.active_status.toInt() == 1) {
                            SharedPreferenceUtils.getInstance(this@OTPActivity)
                                ?.setStringValue(
                                    ConstantUtils.USER_MOBILE_No,
                        ...
                        } else if (response.body()!!.data.step.toInt() == 0){
                            val intent = Intent(this@OTPActivity, RegisterTwoActivity::class.java)
    ...
    fun showDialog() {
        var dialog = Dialog(this@OTPActivity)
        dialog.getWindow()!!
            .setLayout(
    ...
    fun loginFireBase(response: Response<OtpVerifyResponse>) {
        ...
        FirebaseAuth.getInstance().signInWithEmailAndPassword(
            response.body()!!.data.mobile + "@gamil.com",
            response.body()!!.data.mobile
        )
